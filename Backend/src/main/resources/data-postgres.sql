...
/*PATIENT*/
 ...
 values ('patient@maildrop.cc', '$2a$10$Hef/d2ZrMjGXUFE60xUVU.u0up/nV2cIJMg9GDevEgnv5cCcJpTpW', 'Pacijent', 'Mali', '065258155','Marsala tita','Novi Sad',
...
/*DOCTOR*/
 ...
 values ('doca2@gmail.com', '$2a$10$Hef/d2ZrMjGXUFE60xUVU.u0up/nV2cIJMg9GDevEgnv5cCcJpTpW', 'Doca', 'Docic', '065256856','10:30','18:00',1,'ACTIVE',1);
...
insert into doctor_authority(user_id, authority_id) values (3,4);
 ...
 insert into doctor (email, password, first_name, last_name, phone_number,work_hours_from,work_hours_to,clinic_id,status,specialized_id)
 values ('doca5@gmail.com', '$2a$10$Hef/d2ZrMjGXUFE60xUVU.u0up/nV2cIJMg9GDevEgnv5cCcJpTpW', 'Doca', 'Docic', '075256886','05:00','19:00',1,'ACTIVE',1);
...
insert into date_time_interval (start_date_time, end_date_time) values ('19.11.2019 11:00','19.11.2019 12:00');
insert into examination (kind,interval_id,status,examination_type_id,clinic_id,clinic_administrator_id,room_id,patient_id)
values ('EXAMINATION',9,'APPROVED',2,1,1,1,1);
insert into examining (examination_id,doctor_id) values (9,5);

insert into date_time_interval (start_date_time, end_date_time) values ('19.11.2019 10:30','19.11.2019 11:00');
insert into examination (kind,interval_id,status,examination_type_id,clinic_id,clinic_administrator_id,room_id,patient_id)
values ('EXAMINATION',10,'APPROVED',2,1,1,1,1);
insert into examining (examination_id,doctor_id) values (10,6);

insert into date_time_interval (start_date_time, end_date_time) values ('19.11.2019 15:00','19.11.2019 16:00');
insert into examination (kind,interval_id,status,examination_type_id,clinic_id,clinic_administrator_id,room_id,patient_id)
values ('EXAMINATION',11,'APPROVED',2,1,1,1,1);
insert into examining (examination_id,doctor_id) values (11,6);

insert into date_time_interval (start_date_time, end_date_time) values ('19.11.2019 14:00','19.11.2019 14:30');
insert into examination (kind,interval_id,status,examination_type_id,clinic_id,clinic_administrator_id,room_id,patient_id)
values ('EXAMINATION',12,'APPROVED',2,1,1,1,1);
insert into examining (examination_id,doctor_id) values (12,6);

insert into date_time_interval (start_date_time, end_date_time) values ('19.11.2019 08:30','19.11.2019 09:00');
insert into examination (kind,interval_id,status,examination_type_id,clinic_id,clinic_administrator_id,patient_id )
 values ('EXAMINATION',13,'AWAITING',1,1,1,1);

 insert into date_time_interval (start_date_time, end_date_time) values ('20.11.2019 08:30','19.11.2019 09:00');
insert into examination (kind,interval_id,status,examination_type_id,clinic_id,clinic_administrator_id,patient_id )
